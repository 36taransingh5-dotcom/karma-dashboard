    ...
    <div className="max-w-3xl">
      <div className={cardClass[userTier]}>
        ...
        <div className="space-y-1">
          {allTx.map((tx) => (
            <div key={tx.id} className={`flex justify-between items-center py-3 px-4 rounded-lg ${
              ...
              <div className={`text-xs mr-6 ${userTier === "posh" ? "text-amber-500/40" : userTier === "broke" ? "text-lime-700" : "text-slate-400"}`}>
                {tx.date}
              </div>
